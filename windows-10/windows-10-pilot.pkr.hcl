source "vsphere-iso" "Pilot" {
  ...
  iso_paths               = ["[${var.datastoreISO}] en-gb_windows_10_business_editions_version_21h2_x64_dvd_71e6101d.iso", "[${var.datastoreISO}] VMware-tools-windows-11.3.0-18090558.iso"]
  remove_cdrom            = true
...
build {
  sources                 = ["source.vsphere-iso.Pilot"]
